...
from .prompt_it import DEFAULT_PROMPT_NAME, DEFAULT_INITIAL_PROMPT
    ...
    async def handle_list_prompts() -> list[types.Prompt]:
        ...
        return [
            types.Prompt(
                ...
                description="Prompt iniziale per analizzare un dataset di difetti manifatturieri e identificare i driver dei difetti usando SQL DuckDB/MotherDuck.",
            ),
    ...
    async def handle_get_prompt(
        ...
        if name == DEFAULT_PROMPT_NAME:
            return types.GetPromptResult(
                description="Prompt di avvio per l'analisi del dataset Predicting Manufacturing Defects.",
                messages=[
                    types.PromptMessage(
                        role="user",
                        content=types.TextContent(type="text", text=DEFAULT_INITIAL_PROMPT),
                    )
                ],
            )
